#############################################################################
# Makefile for building: AIBotDave
# Generated by qmake (3.1) (Qt 5.10.1)
# Project:  AIBotDave.pro
# Template: app
# Command: /home/duc13t3/Qt/5.10.1/gcc_64/bin/qmake -o Makefile AIBotDave.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
#############################################################################
...
INCPATH       = -I. -I../../Qt/5.10.1/gcc_64/include -I../../Qt/5.10.1/gcc_64/include/QtCore -I. -I../../Qt/5.10.1/gcc_64/mkspecs/linux-g++
QMAKE         = /home/duc13t3/Qt/5.10.1/gcc_64/bin/qmake
DEL_FILE      = rm -f
...
INSTALL_DIR   = cp -f -R
QINSTALL      = /home/duc13t3/Qt/5.10.1/gcc_64/bin/qmake -install qinstall
QINSTALL_PROGRAM = /home/duc13t3/Qt/5.10.1/gcc_64/bin/qmake -install qinstall -exe
DEL_FILE      = rm -f
SYMLINK       = ln -f -s
DEL_DIR       = rmdir
MOVE          = mv -f
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = AIBotDave1.0.0
DISTDIR = /home/duc13t3/QtProject/AIBotDave/.tmp/AIBotDave1.0.0
LINK          = g++
LFLAGS        = -Wl,-rpath,/home/duc13t3/Qt/5.10.1/gcc_64/lib
LIBS          = $(SUBLIBS) -L/home/duc13t3/Qt/5.10.1/gcc_64/lib -lQt5Core -lpthread 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
Makefile: AIBotDave.pro ../../Qt/5.10.1/gcc_64/mkspecs/linux-g++/qmake.conf ../../Qt/5.10.1/gcc_64/mkspecs/features/spec_pre.prf \
		../../Qt/5.10.1/gcc_64/mkspecs/common/unix.conf \
		../../Qt/5.10.1/gcc_64/mkspecs/common/linux.conf \
		../../Qt/5.10.1/gcc_64/mkspecs/common/sanitize.conf \
		../../Qt/5.10.1/gcc_64/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -o Makefile AIBotDave.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
